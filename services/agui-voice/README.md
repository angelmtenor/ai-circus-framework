...
ai-circus-framework agui-voice service
...
3. The application validates these at runtime using Pydantic Settings (`src/agui_voice/data_model.py`).
...
e.g. `uv run agui-voice-hello-world`.
