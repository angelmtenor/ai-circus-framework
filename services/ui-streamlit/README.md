...
ai-circus-framework ui-streamlit service
...
3. The application validates these at runtime using Pydantic Settings (`src/ui_streamlit/data_model.py`).
...
e.g. `uv run ui-streamlit-hello-world`.
