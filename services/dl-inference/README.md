...
ai-circus-framework dl-inference service
...
3. The application validates these at runtime using Pydantic Settings (`src/dl_inference/data_model.py`).
...
e.g. `uv run dl-inference-hello-world`.
