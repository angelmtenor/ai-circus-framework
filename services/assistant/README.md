...
ai-circus-framework assistant service
...
3. The application validates these at runtime using Pydantic Settings (`src/assistant/data_model.py`).
...
e.g. `uv run assistant-hello-world`.
