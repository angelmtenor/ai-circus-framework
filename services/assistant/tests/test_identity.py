"""Tests for assistant's core/identity.py — a thin FastAPI wrapper around
...
import assistant.core.identity as identity_module
...
def test_admin_api_key_is_unwrapped_from_secretstr(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    identity_module.resolve_identity(scenario_slug="churn", authorization="Bearer ai-circus-2026")
