...
ai-circus-framework training service
...
3. The application validates these at runtime using Pydantic Settings (`src/training/data_model.py`).
...
e.g. `uv run training-hello-world`.
