...
ai-circus-framework rag-agent service
...
3. The application validates these at runtime using Pydantic Settings (`src/rag_agent/data_model.py`).
...
e.g. `uv run rag-agent-hello-world`.
