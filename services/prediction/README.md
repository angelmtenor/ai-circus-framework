...
ai-circus-framework prediction service
...
3. The application validates these at runtime using Pydantic Settings (`src/prediction/data_model.py`).
...
e.g. `uv run prediction-hello-world`.
