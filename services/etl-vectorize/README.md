...
ai-circus-framework etl-vectorize service
...
3. The application validates these at runtime using Pydantic Settings (`src/etl_vectorize/data_model.py`).
...
e.g. `uv run etl-vectorize-hello-world`.
