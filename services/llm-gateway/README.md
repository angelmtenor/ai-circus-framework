...
ai-circus-framework llm-gateway service
...
3. The application validates these at runtime using Pydantic Settings (`src/llm_gateway/data_model.py`).
...
e.g. `uv run llm-gateway-hello-world`.
