...
ai-circus-framework etl-tabular service
...
3. The application validates these at runtime using Pydantic Settings (`src/etl_tabular/data_model.py`).
...
e.g. `uv run etl-tabular-hello-world`.
