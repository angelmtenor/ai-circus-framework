...
ai-circus-framework data-platform-manager service
...
3. The application validates these at runtime using Pydantic Settings (`src/data_platform_manager/data_model.py`).
...
e.g. `uv run data-platform-manager-hello-world`.
