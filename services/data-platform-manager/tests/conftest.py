"""Shared test fixtures for the data-platform-manager test suite."""
...
import data_platform_manager.core.logger as _logger_module
...
def reset_singletons() -> Generator[None]:
    ...
    sys.modules.pop("data_platform_manager.data_model", None)
