...
import data_platform_manager.app as app
...
def test_main_exits_when_demo_admin_key_used_outside_dev_profiles(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    is refused, not silently allowed — see enforce_safe_for_public_deployment. This
    matters even more here than in most services: this API can trigger Kubernetes
    Jobs and read gateway configuration.
    """
    fake_logger = FakeLogger()
