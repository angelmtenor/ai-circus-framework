...
SECRET_SPECS=(
  ...
  "assistant-secrets|OBJECT_STORE_ACCESS_KEY,OBJECT_STORE_SECRET_KEY,LITELLM_MASTER_KEY,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,LOGTO_ISSUER,LOGTO_API_RESOURCE_INDICATOR"
  "rag-agent-secrets|GOOGLE_API_KEY,VOYAGE_API_KEY,LITELLM_MASTER_KEY,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,LOGTO_ISSUER,LOGTO_API_RESOURCE_INDICATOR"
  "form-agent-secrets|GOOGLE_API_KEY,VOYAGE_API_KEY,OBJECT_STORE_ACCESS_KEY,OBJECT_STORE_SECRET_KEY,LITELLM_MASTER_KEY,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,LOGTO_ISSUER,LOGTO_API_RESOURCE_INDICATOR"
