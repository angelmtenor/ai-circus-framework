...
#   - <service>-secrets / postgres-credentials / keycloak-secrets: one Secret per
...
#     Middleware (k8s/base/middleware.yaml) gating keycloak-admin/seaweedfs-console.
...
SECRET_SPECS=(
  ...
  "keycloak-secrets|POSTGRES_USER,POSTGRES_PASSWORD,KEYCLOAK_ADMIN_USERNAME,KEYCLOAK_ADMIN_PASSWORD"
  "platform-registry-secrets|POSTGRES_USER,POSTGRES_PASSWORD,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,LITELLM_MASTER_KEY,AUTH_DISABLED,KEYCLOAK_ISSUER,KEYCLOAK_AUDIENCE,KEYCLOAK_M2M_CLIENT_ID,KEYCLOAK_M2M_CLIENT_SECRET"
  "llm-gateway-secrets|LITELLM_MASTER_KEY,OPENAI_API_KEY,GOOGLE_API_KEY,AZURE_OPENAI_API_KEY,AZURE_OPENAI_API_BASE,DEEPSEEK_API_KEY,GROQ_API_KEY,OPENROUTER_API_KEY,ANTHROPIC_API_KEY,LANGFUSE_PUBLIC_KEY,LANGFUSE_SECRET_KEY"
  "prediction-secrets|OBJECT_STORE_ACCESS_KEY,OBJECT_STORE_SECRET_KEY,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,KEYCLOAK_ISSUER,KEYCLOAK_AUDIENCE"
  "assistant-secrets|POSTGRES_USER,POSTGRES_PASSWORD,OBJECT_STORE_ACCESS_KEY,OBJECT_STORE_SECRET_KEY,LITELLM_MASTER_KEY,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,KEYCLOAK_ISSUER,KEYCLOAK_AUDIENCE"
  "rag-agent-secrets|POSTGRES_USER,POSTGRES_PASSWORD,GOOGLE_API_KEY,VOYAGE_API_KEY,LITELLM_MASTER_KEY,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,KEYCLOAK_ISSUER,KEYCLOAK_AUDIENCE"
  "form-agent-secrets|POSTGRES_USER,POSTGRES_PASSWORD,GOOGLE_API_KEY,VOYAGE_API_KEY,OBJECT_STORE_ACCESS_KEY,OBJECT_STORE_SECRET_KEY,LITELLM_MASTER_KEY,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,KEYCLOAK_ISSUER,KEYCLOAK_AUDIENCE"
  "agui-voice-secrets|VOICE_STT_PROVIDER,VOICE_TTS_PROVIDER,VOICE_WHISPER_MODEL,VOICE_PIPER_VOICE_ID,VOICE_PIPER_VOICE_ID_ES,DEEPGRAM_API_KEY,ELEVENLABS_API_KEY,ELEVENLABS_VOICE_ID,CARTESIA_API_KEY,CARTESIA_VOICE_ID,AUTH_DISABLED,ADMIN_API_KEY,ENGINEERING_DEMO_API_KEY,KEYCLOAK_ISSUER,KEYCLOAK_AUDIENCE"
  ...
  # own password; MLflow only the Postgres + SeaweedFS credentials.
  "langfuse-secrets|POSTGRES_USER,POSTGRES_PASSWORD,OBJECT_STORE_ACCESS_KEY,OBJECT_STORE_SECRET_KEY,LANGFUSE_INIT_USER_EMAIL,LANGFUSE_INIT_USER_PASSWORD,LANGFUSE_PUBLIC_KEY,LANGFUSE_SECRET_KEY,LANGFUSE_NEXTAUTH_SECRET,LANGFUSE_SALT,LANGFUSE_ENCRYPTION_KEY,CLICKHOUSE_PASSWORD"
  "clickhouse-secrets|CLICKHOUSE_PASSWORD"
  "mlflow-secrets|POSTGRES_USER,POSTGRES_PASSWORD,OBJECT_STORE_ACCESS_KEY,OBJECT_STORE_SECRET_KEY"
)
